...
def test_definition_initialization():
    definition = Definition(type="base", name="BaseDefinition", docstring="This is a base definition")
...
def test_function_definition_initialization():
    function_def = FunctionDefinition(type="function", name="my_function", docstring="This is a function", file="file.py", arguments=["arg1", "arg2"])
...
def test_class_definition_initialization():
    method_def = FunctionDefinition(type="method", name="my_method", docstring="This is a method", file="file.py", arguments=["self", "arg1"])
    class_def = ClassDefinition(type="class", name="MyClass", docstring="This is a class", file="file.py", methods=[method_def])
...
def test_method_definition_initialization():
    method_def = MethodDefinition(type="method", name="my_method", docstring="This is a method", arguments=["self", "arg1"])
